<header class="main-header">
	<nav class="navbar">
		<div class="container">
			<a class="navbar-brand p-0 m-0" href="<?php echo $ucafeSG ?>">
	...
	<div class="menu-dot d-none d-lg-block">
		<ul class="list-unstyled m-0">
			<a href="<?php echo $ucafeSG ?>instant/?idProduct=1" class="text-white"><li>
				<label>INSTANT SERIES</label>
				<i class="bi bi-circle-fill"></i>
			</li></a>
			<a href="<?php echo $ucafeSG ?>pure/?idProduct=6" class="text-white"><li>
				<label>PURE SERIES</label>
				<i class="bi bi-circle-fill"></i>
			</li></a>
			<a href="<?php echo $ucafeSG ?>findus" class="text-white"><li>
				<label>FIND US</label>
				<i class="bi bi-circle-fill"></i>
			</li></a>
		</ul>
