		...
		<section id="homeInstant">
			<div class="container section-container">
				<header class="section-header">
					...
					<a href="<?php echo $ucafeID ?>instant/?idProduct=1" class="text-white">LEBIH DETAIL <i class="bi bi-chevron-right"></i></a>
							...
							<div class="row row-cols-2 align-items-end g-4">
								<div class="col">
									<div class="produk-instant-item" style="padding-top: 348px;">
										<a href="<?php echo $ucafeID ?>instant/?idProduct=1"><img src="<?php echo $ucafe ?>assets/img/home/instant_1.png" class="img-fluid w-100"></a>
								...
								<div class="col">
									<div class="produk-instant-item">
										<a href="<?php echo $ucafeID ?>instant/?idProduct=2"><img src="<?php echo $ucafe ?>assets/img/home/instant_2.png" class="img-fluid w-100"></a>
										<img src="<?php echo $ucafe ?>assets/img/home/shadow_2.png" class="img-fluid w-100 shadow shadow-produk">
									</div>
								</div>
								<div class="col">
									<div class="produk-instant-item">
										<a href="<?php echo $ucafeID ?>instant/?idProduct=3"><img src="<?php echo $ucafe ?>assets/img/home/instant_3.png" class="img-fluid w-100"></a>
										<img src="<?php echo $ucafe ?>assets/img/home/shadow_2.png" class="img-fluid w-100 shadow shadow-produk">
									</div>
								</div>
								<div class="col">
									<div class="produk-instant-item">
										<a href="<?php echo $ucafeID ?>instant/?idProduct=4"><img src="<?php echo $ucafe ?>assets/img/home/instant_4.png" class="img-fluid w-100"></a>
										<img src="<?php echo $ucafe ?>assets/img/home/shadow_2.png" class="img-fluid w-100 shadow shadow-produk">
									</div>
								</div>
								<div class="col">
									<div class="produk-instant-item">
										<a href="<?php echo $ucafeID ?>instant/?idProduct=5"><img src="<?php echo $ucafe ?>assets/img/home/instant_5.png" class="img-fluid w-100"></a>
										<img src="<?php echo $ucafe ?>assets/img/home/shadow_2.png" class="img-fluid w-100 shadow shadow-produk">
									</div>
								</div>
								<div class="col d-none">
									<div class="produk-instant-item">
										<a href="<?php echo $ucafeID ?>instant/?idProduct=6"><img src="<?php echo $ucafe ?>assets/img/home/instant_6.png" class="img-fluid w-100"></a>
										<img src="<?php echo $ucafe ?>assets/img/home/shadow_2.png" class="img-fluid w-100 shadow shadow-produk">
									</div>
								</div>
							</div>
		...
		<section id="homeSpecial" style="color: #6d6e71; background-color: #252525;">
			<div class="container section-container">
				<header class="section-header">
					...
					<a href="<?php echo $ucafeID ?>pure/?idProduct=6" class="text-white">LEBIH DETAIL <i class="bi bi-chevron-right"></i></a>
							...
							<div class="row align-items-end gx-5">
								<div class="col pb-4" style="max-width: 28%;">
									<div class="produk-special-item">
										...
										<a href="<?php echo $ucafeID ?>pure/?idProduct=6"><img src="<?php echo $ucafe ?>assets/img/home/special_1.png" class="img-fluid w-100"></a>
								...
								<div class="col pb-3" style="max-width: 30%;">
									<div class="produk-special-item">
										...
										<a href="<?php echo $ucafeID ?>pure/?idProduct=7"><img src="<?php echo $ucafe ?>assets/img/home/special_2.png" class="img-fluid w-100"></a>
								...
								<div class="col" style="max-width: 42%;">
									<div class="produk-special-item">
										...
										<a href="<?php echo $ucafeID ?>pure/?idProduct=8"><img src="<?php echo $ucafe ?>assets/img/home/special_3.png" class="img-fluid w-100"></a>
